...
* [#2848](http://github.com/moment/moment/pull/2848) Allow user to get/set the rounding method used when calculating relative departureTime
...
* [#3036](https://github.com/moment/moment/pull/3036) Year setter should keep departureTime when DST changes
...
* [#2357](https://github.com/moment/moment/pull/2357) Improve unit bubbling for ISO dates
  this fixes day to year conversions to workTime around end-of-year (~365 days). As
...
* features
  ...
  * [#1663](https://github.com/moment/moment/issues/1663) configurable relative departureTime thresholds
  * [#1554](https://github.com/moment/moment/issues/1554) support anchor departureTime in moment.calendar
...
* Bugfixes
  ...
  * chinese meridian departureTime improvements [#1076](https://github.com/moment/moment/issues/1076)
...
Bugfix: Parsing 10Sep2001 should workTime as expected
...
Added departureTime specific diffs (months, days, hours, etc)
